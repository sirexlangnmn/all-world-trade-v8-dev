...
const validationMiddleware = [
    ...
    check('businessEmailAddress').not().isEmpty().withMessage('S: Business Email Address is required').trim().escape().isEmail().normalizeEmail().withMessage('S: Invalid Email Address.'),
