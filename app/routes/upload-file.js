...
app.post('/upload1', upload.single('image'), async (req, res) => {
    console.log('upload1 req.file', req.file);
    console.log('upload1 res.file.filename', res.file.filename);

    const imagePath = path.join(__dirname, '../../', 'public/uploads/users_upload_files/', req.file.filename);
    console.log('upload1 imagePath:', imagePath);
  const image = await sharp(imagePath)
    .resize(800, 600)
    .webp()
    .toFile(imagePath + '.webp');
    console.log('upload1: Image uploaded and converted successfully!');
